...
**What is it**
Sefia is an AI agent inspired by a certain city (https://thebrokenrealm.net)(https://thebrokenrealm.net) in a *certain* book. 
...
Note:
you must be signed in to use Cloud use (ollama.com)(ollama.com) to sign in/up *its free* 
